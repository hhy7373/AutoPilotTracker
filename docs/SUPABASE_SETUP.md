...
9. `supabase/migrations/202609100001_v041_catalog_review_and_admin.sql`
10. `supabase/migrations/202609160001_v041_official_catalog_evidence.sql`
11. `supabase/migrations/202609100002_v041_public_catalog_views.sql`
...
v0.4.1 的三条迁移必须在 v0.3.2 目录状态迁移之后执行：先执行 `202609100001`，再执行 `202609160001`，最后执行 `202609100002`。第一条增加 `vehicle_brand`、来源核验补充字段、`system_vehicle_compatibility` 和管理员证据读取策略；中间脚本只发布有官方原文直接支持的产品/方案版本、车型和搭载关系；最后一条重建公开版本统计视图。不能只部署前端或 API 来替代数据库迁移。
