...
- 华为乾崑智驾 ADS 4：官方新闻直接写明 2025-04-22 发布 ADS 4；仅记录为产品/方案版本，不推断逐车型 OTA。
- 小鹏 P7、2026 款 G6：官方车型页直接写明第二代 VLA、图灵 AI 芯片和 2250TOPS；仅记录为产品/方案版本及对应车型关系。
- 理想 L6：官方车型页直接展示马赫 VLA/M100；不推断 AD Pro/Max 的逐配置映射。
- 蔚来 ET5T：官方车型页直接展示 NOP+、Cedar S AQUILA 和 Cedar S ADAM；不推断 OTA 构建号。
- 小米 SU7：官方车型页直接展示 Xiaomi HAD、激光雷达、4D 毫米波雷达和 700TOPS；不推断 OTA 构建号。
- 文远知行 WRD 3.0：官网直接列出 WRD 3.0 One-Stage End-to-End ADAS，按技术方案版本记录，不作为车企 OTA。

对应数据库种子为 `202609160001_v041_official_catalog_evidence.sql`。地平线、卓驭以及缺少官方逐配置原文的记录继续保持草稿。
